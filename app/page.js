    ...
    <>
      ...
      <section className="min-h-[70vh] flex flex-col justify-center items-center text-white px-6 text-center">
        <div className="flex items-center gap-3 mb-4 whitespace-nowrap">
          <h1 className="text-4xl md:text-6xl sm:text-2xl font-extrabold bg-gradient-to-r from-purple-400 to-cyan-400 bg-clip-text text-transparent">
            Get Me a Chai
          </h1>
      ...
      <section className="container mx-auto py-20 px-6 text-white">
        ...
        <div className="grid md:grid-cols-3 gap-8">
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-8 text-center hover:scale-105 transition duration-300">
            ...
            <h3 className="font-bold text-xl mt-5 mb-3">Support Creators</h3>
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-8 text-center hover:scale-105 transition duration-300">
            ...
            <h3 className="font-bold text-xl mt-5 mb-3">Easy Payments</h3>

            <p className="text-gray-300">
              Fast, secure, and hassle-free payments for creators and
              supporters.
            </p>
          </div>
          ...
          <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-8 text-center hover:scale-105 transition duration-300">
            ...
            <h3 className="font-bold text-xl mt-5 mb-3">Build Community</h3>
      ...
      <section className="py-20 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          <p className="text-center text-gray-400 max-w-2xl mx-auto mb-14">
            Get Me A Chai is a crowdfunding platform that enables fans to
            support their favorite creators through secure online payments.
            Whether you're a developer, artist, musician, writer, or content
            creator, your community can contribute and help bring your ideas to
            life.
          </p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-6 hover:border-green-400 transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-400">
                Help your favorite creators by buying them a chai with just a
                few clicks.
              </p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-6 hover:border-purple-400 transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-400">
                Sign in securely using NextAuth and manage your creator profile
                with ease.
              </p>
            </div>
            ...
            <div className="bg-white/5 backdrop-blur-lg border border-white/10 rounded-2xl p-6 hover:border-yellow-400 transition-all duration-300 hover:-translate-y-2">
              ...
              <p className="text-gray-400">
                Built with Next.js, MongoDB, and Tailwind CSS for a smooth
